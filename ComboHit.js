var scriptName = "ComboHit";
var scriptVersion = 1.0;
var scriptAuthor = "zxczenos";

var zenosCombo = new ComboHit();
var client;
...
var ComboHit = new ComboHit();

function onLoad() {}

function onEnable() {
    moduleManager.registerModule(ComboHit);
};

function onDisable() {
    moduleManager.unregisterModule(ComboHit);
};
